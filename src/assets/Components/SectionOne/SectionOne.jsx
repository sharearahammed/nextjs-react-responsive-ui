...
"
        ...
        <div className="mt-[50px] md:mt-[56px] lg:mt-0">
          <div className="grid grid-cols-2 md:grid-cols-1 gap-3 md:gap-0">
            <div>
              <h1 className="font-bold text-[16px] md:text-[26px] lg:mb-2 lg:ml-36">
                Photos
              </h1>
              <div className="grid grid-cols-2 gap-0 justify-center items-center">
                <img
                  className="lg:h-[200px] w-full lg:ml-24"
                  src="./Rectangle 2.svg"
                  alt=""
                />
                <img
              ...
              <p className="text-[12px] md:text-[16px] flex justify-end md:mr-12 text-[#196AA0] font-semibold hover:cursor-pointer">
                More +
              </p>
            </div>
            <div className="md:mt-5 lg:mt-10">
              ...
              <div className="grid grid-cols-1 gap-0 justify-center items-center">
                <img
                  className="lg:h-[215px] w-full lg:ml-12"
                  src="./Video.svg"
                  alt=""
                />
                <div className="mt-5 lg:mt-1 lg:ml-10 grid grid-cols-3 gap-1 md:gap-0">
                  <img
                    className="lg:ml-[81px] lg:h-[115px] w-full"
                    src="./Video 1.svg"
                    alt=""
                  />
                  <img
                    className="lg:ml-[27px] lg:h-[115px] w-full"
                    src="./Video 2.svg"
                    alt=""
                  />
                  <img
                    className="lg:-ml-[26px] lg:h-[115px] w-full"
                    src="./Video 3.svg"
                    alt=""
                  />
                </div>
              </div>
              <p className="mt-1 md:mt-0 text-[12px] md:text-[16px] flex justify-end md:mr-12 text-[#196AA0] font-semibold hover:cursor-pointer">
                More +
              </p>
            </div>
          </div>
